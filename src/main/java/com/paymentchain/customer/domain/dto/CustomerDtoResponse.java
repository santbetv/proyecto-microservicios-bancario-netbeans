 ...
 * @author rizzoli
 */
@Schema(name = "CustomerDtoResponse",  description = "Model represent the domian Customer on database")
@Getter
@Setter
public class CustomerDtoResponse {
    
    @Schema(name = "id", required = true, example = "1", defaultValue = "1", description = "Id de customer")
    private long id;
    ...
    @Schema(name = "transactions", required = false, example = "[{}]", defaultValue = "[{}]", description = "transactions de customer")
